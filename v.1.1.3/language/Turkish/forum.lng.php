...
$lang = array_merge((array)$lang, array(
    ...
    'forum_log_move' => 'Konu Taşındı',
    'forum_log_bump' => 'Konu Yukarı Taşındı (Bump)',
    ...
    /* ───────── v1.1.3 YENİ ÖZELLİKLER ───────── */
'forum_prefix'            => 'Önek',
'forum_tag_input'         => 'Etiketler (virgülle ayırın)',
'forum_description'       => 'Konu Açıklaması',
'forum_unanswered'        => 'Yanıtlanmamış Konular',
'forum_no_unanswered'     => 'Yanıtlanmamış konu bulunmuyor.',
'forum_active'            => 'Aktif Konular',
'forum_no_active'         => 'Bu dönemde aktif konu yok.',
'forum_tags'              => 'Etiketler',
'forum_no_tags'           => 'Henüz etiket eklenmemiş.',
'forum_no_topics_tag'     => 'Bu etiketle konu bulunamadı.',
'forum_mark_all_read'     => 'Tümünü Okundu İşaretle',

    /* ───────── v1.1.3 TOPLU MODERASYON & ADMIN ───────── */
'forum_adm_bulk_done'     => 'Toplu işlem başarıyla uygulandı.',
'forum_adm_bulk_confirm'  => 'Seçili konulara bu işlemi uygulamak istediğinizden emin misiniz?',
'forum_adm_move_cat'      => 'Taşınacak kategori',
'forum_adm_select_all'    => 'Tümünü Seç',
'forum_adm_sort_hint'     => 'Sıralama (Küçük sayı üstte çıkar)',
'forum_adm_prefixes'      => 'Önek Yönetimi',

    /* ───────── v1.1.3 ADMIN PANEL: PREFIX & ETİKET YÖNETİMİ ───────── */
'forum_adm_nav_prefixes'   => 'Önekler',
'forum_adm_nav_tags'       => 'Etiketler',
'forum_adm_prefixes'       => 'Önek Yönetimi',
'forum_adm_prefix_add'     => 'Yeni Önek Ekle',
'forum_adm_prefix_title'   => 'Önek Başlığı',
'forum_adm_prefix_cat'     => 'Kategori',
'forum_adm_prefix_color'   => 'Renkler',
'forum_adm_prefix_order'   => 'Sıra',
'forum_adm_prefix_edit'    => 'Öneği Düzenle',
'forum_adm_prefix_new'     => 'Yeni Önek',
'forum_adm_prefix_saved'   => 'Önek başarıyla güncellendi.',
'forum_adm_prefix_added'   => 'Yeni önek eklendi.',
'forum_adm_prefix_del'     => 'Önek silindi.',
...
'forum_adm_tag_edit'       => 'Etiketi Düzenle',
    ...
    'forum_adm_tag_saved'      => 'Etiket başarıyla güncellendi.',
    'forum_adm_tag_del'        => 'Etiket silindi.',

    /* ───────── v1.1.3 AYARLAR VE DİĞER ───────── */
    'forum_clean_readlog_days' => 'Okuma geçmişi temizleme (gün)',


    'forum_err_msg_format'    => 'Geçersiz mesaj formatı.',
    'forum_err_file_verify'   => 'Dosya türü doğrulanamadı!',
    'forum_err_pm_fail'       => 'PM gönderilemedi.',
    'forum_all_cats'          => 'Tüm Kategoriler',
    'forum_filter_today'      => 'Bugün',
    'forum_filter_week'       => 'Son 7 Gün',
    'forum_filter_month'      => 'Son 30 Gün',
    'forum_save_order'        => 'Sıralamayı Kaydet',
    'forum_order_ok'          => 'Sıralama başarıyla güncellendi!',
    'forum_no_cats_found'     => 'Hiç kategori bulunamadı.',
    'forum_color_text'        => 'Yazı Rengi',
    'forum_color_bg'          => 'Arkaplan',
    'forum_bulk_apply'        => 'Uygula',
    'forum_bulk_move'         => 'Taşı',
    'forum_new_msg_alert'     => 'Yeni mesaj var',
    'forum_adm_ver_ok'        => 'SÜRÜM GÜNCEL',
    'forum_adm_ver_new'       => 'YENİ SÜRÜM: v%s',
    'forum_home'              => 'Ana Sayfa',

    /* ───────── YENİ EKLENEN (v1.1.3 Temizlik) ───────── */
    'forum_err_pm_invalid'    => 'Geçersiz alıcı adı!',
    'forum_js_msg_del_ok'     => 'Mesaj silindi, sayfa yenileniyor...',
    ...
    /* ───────── YENİ EKLENEN (Edit Topic Sayfası) ───────── */
    'forum_adm_edit_topic'        => 'Konuyu Düzenle',
    'forum_adm_back'              => 'Geri Dön',
    'forum_adm_topic_title'       => 'Konu Başlığı',
    'forum_adm_topic_prefix'      => 'Konu Öneki',
    'forum_adm_topic_desc'        => 'Kısa Açıklama',
    'forum_adm_topic_tags'        => 'Etiketler',
    'forum_adm_topic_cat'         => 'Kategori',
    'forum_adm_topic_content'     => 'Mesaj İçeriği',
    'forum_adm_topic_options'     => 'Seçenekler',
    'forum_adm_pin_topic'         => 'Sabit Konu Yap (Yukarıda tut)',
    'forum_adm_lock_topic'        => 'Konuyu Kilitle (Cevap yazılamasın)',
    'forum_adm_topic_not_found'   => 'Konu bulunamadı!',
    ...
    'forum_set_sticky_op'    => 'Sticky OP: İlk Mesaj Her Sayfada Sabitlensin',
    'forum_topic_starter'    => 'Konu Sahibi',
    'forum_original_post'    => 'Konunun Başı',

    /* ───────── v1.1.3 Admin Topic List ───────── */
    'forum_adm_topic_list'    => 'Konu Listesi',
    'forum_adm_no_topics'     => 'Henüz hiç konu bulunmuyor.',
    ...
    'forum_adm_manage'        => 'Forum Yönetimi',
    'forum_order_ok'          => 'Sıralama başarıyla güncellendi!',
    'forum_ph_tags'           => 'etiket1, etiket2',
    'forum_view_profile'      => 'Profile Git',
