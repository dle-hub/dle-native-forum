...
<div class="df-page-wrap">
    ...
    <nav class="df-breadcrumb">
        ...
        <i class="fa fa-chevron-right df-breadcrumb-sep"></i>
        <span class="df-breadcrumb-current">Aktif Konular</span>
    </nav>
    ...
    <div class="df-category-hero">
        <div class="df-hero-info">
            ...
            <div>
                <h1 class="df-hero-title">Aktif Konular</h1>
                <p class="df-hero-desc">Son 7 günde aktif olan {total_count} konu.</p>
            </div>
        </div>
    </div>
