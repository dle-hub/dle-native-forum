...
$lang = array_merge((array)$lang, array(
    ...
    'err_flood_blocked'    => 'Ви зробили забагато запитів! Вам потрібно зачекати 10 хвилин.',
    'err_flood_ip'         => 'Досягнуто погодинний ліміт запитів. Будь ласка, зачекайте.',
    'err_flood_post'       => 'Ви виконуєте дії занадто швидко! Вам потрібно зачекати %s секунд.',
