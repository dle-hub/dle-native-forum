...
'forum_replies'                  => 'Відповідь',
'forum_replies_count'            => 'Відповідей',
'forum_views'                    => 'Перегляди',
'forum_views_count'              => 'Переглядів',
'forum_status'                   => 'Статус',
...
'forum_set_topics_per_page_desc' => 'Кількість тем, що відображаються на одній сторінці.',
'forum_set_guest_view'           => 'Гості бачать (1/0)',
'forum_set_guest_view_desc'      => 'Дозволити гостям переглядати форум?',
'forum_set_min_post'             => 'Мін. довжина повідомлення',
'forum_set_min_post_desc'        => 'Мінімальна кількість символів у повідомленні.',
'forum_set_max_post'             => 'Макс. довжина повідомлення',
'forum_set_max_post_desc'        => 'Максимальна кількість символів у повідомленні.',
'forum_set_allow_member_edit'    => 'Редагування повідомлень користувачами',
'forum_set_allow_member_edit_desc' => 'Дозволити користувачам редагувати свої повідомлення? Якщо вимкнено, редагувати можуть тільки адміни та редактори.',
