    ...
    <div class="df-card">
        <div class="df-card-header">
            <h1 class="df-card-title">
                <i class="fa fa-pencil-square-o"></i> Konuyu Düzenle: {title}
            </h1>
        </div>
            ...
            <form method="POST" class="df-form-layout" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="df-form-group">
                        <label class="df-form-label">Konu Ön Eki</label>
                        {prefix_select}
                    </div>
                    <div class="df-form-group">
                        <label class="df-form-label">Konu Başlığı</label>
                        <input type="text" name="topic_title" value="{topic_title_val}" class="df-search-input" required style="height: 44px;">
                    </div>
                </div>

                <div class="df-form-group" style="margin-bottom: 20px;">
                    <label class="df-form-label">Kısa Açıklama (Opsiyonel)</label>
                    <input type="text" name="topic_description" value="{description_val}" class="df-search-input" maxlength="500" style="height: 44px;">
                </div>

                <div class="df-form-group" style="margin-bottom: 20px;">
                    <label class="df-form-label">Etiketler (Virgül ile ayırın)</label>
                    <input type="text" name="tags" value="{tags_val}" class="df-search-input" placeholder="etiket1, etiket2" style="height: 44px;">
                </div>
                ...
                <div class="df-form-actions" style="margin-top: 30px; display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--df-border); padding-top: 20px;">
                    ...
                    <button type="submit" class="df-btn df-btn-primary" style="padding: 12px 36px;">
